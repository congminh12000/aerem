...
if(!empty($value['value'])) {
    if ($social['slug'] == "Whatsapp" || $social['slug'] == "Phone" || $social['slug'] == "SMS") {
...
//                        $value['value'] = "+".$value['value'];
                    ...
                    <div class="channels__input-box mb-1">
                        <input data-label="<?php echo esc_attr($social['title']) ?>" placeholder="<?php echo esc_attr($placeholder); ?>" type="text" class="w-11/12 channels__input custom-channel-<?php echo esc_attr__($channel_type) ?> <?php echo isset($social['attr']) ? $social['attr'] : "" ?>" name="cht_social_<?php echo esc_attr($social['slug']); ?>[value]" value="<?php echo esc_attr(wp_unslash($value['value'])); ?>" data-gramm_editor="false" id="channel_input_<?php echo esc_attr($social['slug']); ?>" />
                    </div>
                <?php } ?>
        ...
        <?php if ($social['slug'] == "Whatsapp" || $social['slug'] == "Link" || $social['slug'] == "Custom_Link" || $social['slug'] == "Custom_Link_3" || $social['slug'] == "Custom_Link_4" || $social['slug'] == "Custom_Link_5") { ?>
            <div class="Whatsapp-settings advanced-settings extra-chaty-settings">
                ...
                <div class="chaty-setting-col">
                    ...
                    <label class="chaty-switch text-base chaty-embedded-window font-primary text-cht-gray-150 mt-2" for="whatsapp_embedded_window_<?php echo esc_attr($social['slug']); ?>">
                        ...
                        <div class="html-tooltip top">
                            ...
                            <span class="tooltip-text top">
                                ...
                                <img alt="chaty" src="<?php echo esc_url(CHT_PLUGIN_URL) ?>/admin/assets/images/whatsapp-popup.gif" />
                            </span>
                        </div>
                    </label>
                </div>
        ...
        <div class="device-agent-settings mt-2">
            <div class="channels__device-box ml-2">
        ...
        <div class="chaty-advance-settings <?php echo esc_attr($class_name); ?>" style="<?php echo (empty($close_class) && $social['slug'] == 'Contact_Us') ? "display:block" : ""; ?>">
                        ...
                        <div class="form-field-setting-col my-3 space-y-4">
                            ...
                            <div class="redirect_action-settings <?php echo ($field_value == "yes") ? "active" : "" ?>">
                                ...
                                <div class="chaty-setting-col">
                                    ...
                                    <div class="mb-2">
                                        <input class="w-full" id="redirect_link_for_<?php echo esc_attr($social['slug']); ?>" placeholder="<?php echo site_url("/") ?>" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[redirect_link]" value="<?php echo esc_attr($field_value); ?>" >
                                    </div>
                                </div>
                        ...
                        <div class="form-field-setting-col no-margin">
                            ...
                            <div class="chaty-setting-col">
                                <label for="save_leads_locally_<?php echo esc_attr($social['slug']); ?>" class="full-width chaty-switch flex items-center text-cht-gray-150 text-base">
                                    ...
                                    <div class="chaty-slider round"></div>
                                    Save leads to <a class="text-cht-primary underline" href="<?php echo admin_url("admin.php?page=chaty-contact-form-feed") ?>" target="_blank">this site</a>
                                ...
                                <label for="enable_recaptcha_<?php echo esc_attr($social['slug']); ?>" class="email-setting full-width chaty-switch text-base text-cht-gray-150 flex items-center group-custom">
                                    ...
                                    <span class="header-tooltip">
                                        <span class="header-tooltip-text text-center">
                                            <?php printf(esc_html__("Click %s to add your website. (please make sure you select V3). After adding your website you'll get your site Key and secret key.", "chaty"), "<a target='_blank' class='infotip-link' href='https://www.google.com/recaptcha/admin/create'>".esc_html__("here", "chaty")."</a>") ?>
                                        </span>
                                        <span class="ml-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <?php if ($this->is_pro()) { ?>
                    <div class="Email-settings advanced-settings">
                        ...
                        <div class="chaty-setting-col sm:flex items-start sm:space-x-3">
                            <label class="font-primary text-cht-gray-150 w-44 flex"><?php esc_html_e("Mail Subject" ,"chaty") ?>
                    ...
                    <div class="WeChat-settings advanced-settings">
                        ...
                        <div class="chaty-setting-col flex items-center space-x-3">
                            ...
                            <div class="relative">
                                ...
                                <a class="cht-upload-image flex <?php echo esc_attr(($status) ? "active" : "") ?>" id="upload_qr_code" href="javascript:;" onclick="upload_qr_code('<?php echo esc_attr($social['slug']); ?>')">
                                ...
                                <a href="javascript:;" class="remove-qr-code absolute right-1 rounded-full -top-2 remove-qr-code-<?php echo esc_attr($social['slug']); ?> <?php echo esc_attr(($status) ? "active" : "") ?>" onclick="remove_qr_code('<?php echo esc_attr($social['slug']); ?>')"><span class="dashicons dashicons-no-alt"></span></a>
                ...
                <?php } else { ?>
                    ...
                    <div class="Email-settings advanced-settings">
                        ...
                        <div class="chaty-setting-col flex items-start space-x-3">
                            <label class="font-primary text-cht-gray-150 w-44"><?php esc_html_e("Mail Subject", "chaty") ?>
                                <span class="icon label-tooltip inline-tooltip" data-title="<?php esc_html_e("Add your own pre-set message that's automatically added to the user's message. You can also use merge tags and add the URL or the title of the current visitor's page. E.g. you can add the current URL of a product to the message so you know which product the visitor is talking about when the visitor messages you", "chaty") ?>" >
            ...
            <input type="hidden" class="is-agent-active" name="cht_social_<?php echo esc_attr($social['slug']); ?>[is_agent]" value="<?php echo esc_attr($is_agent) ?>"  >
    ...
    <?php if (!in_array($social['slug'], ["Contact_Us", "Link", "Custom_Link", "Custom_Link_3", "Custom_Link_4", "Custom_Link_5", "Custom_Link_6"])) { ?>
        ...
        // if($social['slug'] != "Instagram" && $value['agent_bg_color'] != "#ffffff") {
        if (false) {
            ?>
                    ...
                    <header class="flex items-center gap-2 sm:gap-0 px-2 sm:pr-5 sm:pl-3 py-6 flex-wrap">
                        ...
                        <div class="flex items-center space-x-1 mr-4">
                            ...
                            <div class="agent-icon inline-flex <?php echo esc_attr($imgClass) ?>"  id="image_agent_data_agent-<?php echo esc_attr($social['slug']) ?>">
                                ...
                                <span style="background-color: <?php echo esc_attr($value['agent_bg_color']) ?>" class="facustom-icon flex items-center justify-center" style="background-color: <?php echo esc_attr($value['bg_color']) ?>">
                                ...
                                <!-- <span class="agent-info-image header-tooltip">
                                    <span class="header-tooltip-text text-center">Agent channels will appear when users click the group channel launcher</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M8 5.33203H8.00667" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            if (!empty($agentData)) {
                                ...
                                foreach ($agentData as $key => $agent) {
                                    if (is_numeric($key) && $key != "<?php echo esc_attr($count) ?>") {
                                        ...
                                        $agent_bg_color = isset($agent['agent_bg_color']) ? $agent['agent_bg_color'] : $social['color'];
                                                ...
                                                <div class="agent-channel-setting-top px-2 sm:pl-3 sm:pr-5">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="agent-icon <?php echo esc_attr($imgClass) ?>" id="image_agent_data_<?php echo esc_attr($social['slug']) ?>-<?php echo esc_attr($count) ?>">
                                                            ...
                                                            <span class="agent-info-image header-tooltip">
                                                                <span class="header-tooltip-text text-center"><?php esc_html_e("This channel is an instance of the main channel", "chaty") ?></span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                                    <path d="M8.00004 14.6654C11.6819 14.6654 14.6667 11.6806 14.6667 7.9987C14.6667 4.3168 11.6819 1.33203 8.00004 1.33203C4.31814 1.33203 1.33337 4.3168 1.33337 7.9987C1.33337 11.6806 4.31814 14.6654 8.00004 14.6654Z" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                    <path d="M8 10.6667V8" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                                    <path d="M8 5.33203H8.00667" stroke="#72777c" stroke-width="1.33" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    ...
                                                    <div class="flex-auto">
                                                        <div class="agent-channel-input">
                                                            <input placeholder="<?php echo esc_attr($placeholder); ?>" class="agent-input-value <?php echo ($social['slug'] == "") ? "chaty-whatsapp-phone" : "" ?>" id="cht_social_agent_<?php echo esc_attr($social['slug']); ?>_<?php echo esc_attr($count) ?>" data-id="<?php echo esc_attr($count) ?>" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[agent_data][<?php echo esc_attr($count) ?>][value]" value="<?php echo esc_attr($value) ?>">
                                                ...
                                                <div class="agent-channel-setting-advance hidden">
                                                    <div class="grid grid-cols-2 gap-5">
                                                        ...
                                                        <?php if ($social['slug'] == "Linkedin") { ?>
                                                            ...
                                                            <!-- Advance setting for Custom Link -->
                                                            <div>
                                                                <label class="font-priamry text-cht-gray-150/70 text-base block" ><?php esc_html_e("LinkedIn", "chaty") ?></label>
                ...
                <div style="display: none" class="default-agent-setting">
                    <div class="agent-channel-setting"  id="agent-<?php echo esc_attr($slug) ?>-__count__" data-item="__count__">
                        <div class="agent-channel-setting-top px-2 sm:pl-3 sm:pr-5">
                            ...
                            <div class="flex-auto">
                                <div class="agent-channel-input">
                                    <input placeholder="<?php echo esc_attr($placeholder); ?>" class="agent-input-value <?php echo ($social['slug'] == "") ? "chaty-whatsapp-phone-alt" : "" ?>"  id="cht_social_agent_<?php echo esc_attr($social['slug']); ?>___count__" data-id="__count__" type="text" name="cht_social_<?php echo esc_attr($social['slug']); ?>[agent_data][__count__][value]">
                                    <div class="chaty-agent-setting-col">
                                        <div>
                                            <!-- input for custom title -->
                        ...
                        <div class="agent-channel-setting-advance hidden">
                            <div class="grid grid-cols-2 gap-5">
                                ...
                                <?php if ($social['slug'] == "Linkedin") { ?>
                                <div>
                                    <label class="font-priamry text-cht-gray-150/70 text-base mb-2 block" ><?php esc_html_e("LinkedIn", "chaty") ?></label>
