            ...
            if (!empty($settings)) {
                ...
                if($this->isProductPage) {
                    ...
                    if(!empty($product)) {
                        ...
                        $wooPrice = strip_tags(wc_price($product->get_price()));
                        $wooRegPrice = strip_tags(wc_price($product->get_regular_price()));
                        $wooDisc = strip_tags(wc_price(floatval($product->get_regular_price()) - floatval($product->get_price())));
                    }
                }

                $data['product'] = [
                    'title' => esc_attr($wooName),
                    'sku' => esc_attr($wooSKU),
                    'price' => esc_attr($wooPrice),
                    'regPrice' => esc_attr($wooRegPrice),
                    'discount' => esc_attr($wooDisc),
                ];
        ...
        if(!empty($string)) {
            ...
            if($this->isProductPage) {
                ...
                if(!empty($product)) {
                    $wooName = $product->get_name();
                    $wooSKU = $product->get_sku();
                    $wooPrice = html_entity_decode(strip_tags(wc_price($product->get_price())));
                    $wooRegPrice = html_entity_decode(strip_tags(wc_price($product->get_regular_price())));
                    $wooDisc = html_entity_decode(strip_tags(wc_price(floatval($product->get_regular_price()) - floatval($product->get_price()))));
                }
            }
                ...
                if ($value) {
                    ...
                    if (!empty($value['value']) || $slug == "contact_us" || (isset($value['is_agent']) && $value['is_agent'])) {
                        ...
                        if ($channel_type == "viber") {
                            ...
                            $val = $value['value'];
                            $val = str_replace("+", "", $val);
                            $val = esc_attr($this->cleanStringForNumbers($val));
                        ...
                        if ($channel_type == "whatsapp") {
                            ...
                            $pre_set_message = esc_attr(isset($value['pre_set_message']) ? esc_attr($value['pre_set_message']) : "");
                            ...
                            $pre_set_message      = esc_attr(isset($value['sms_pre_set_message']) ? $value['sms_pre_set_message'] : "");
                        ...
                        if ($channel_type == "contact_us") {
                            ...
                            if (isset($value['name']) || isset($value['email']) || isset($value['message'])) {
                                ...
                                if (isset($field_setting['is_active']) && $field_setting['is_active'] == "yes") {
                                    $contact_fields[] = [
                                        "field"       => "name",
                                        "title"       => isset($field_setting['field_label'])? esc_attr($field_setting['field_label']) :esc_html__("Name", "chaty"),
                                        "is_required" => (isset($field_setting['is_required']) && $field_setting['is_required'] == "yes") ? 1 : 0,
                                        "placeholder" => isset($field_setting['placeholder']) ? esc_attr($field_setting['placeholder']) : esc_html__("Enter your name", "chaty"),
                                        "type"        => "text",
                                    ];
                                }
                                ...
                                if (isset($field_setting['is_active']) && $field_setting['is_active'] == "yes") {
                                    $contact_fields[] = [
                                        "field"       => "email",
                                        "title"       => isset($field_setting['field_label'])? esc_attr($field_setting['field_label']) : esc_html__("Email", "chaty"),
                                        "is_required" => (isset($field_setting['is_required']) && $field_setting['is_required'] == "yes") ? 1 : 0,
                                        "placeholder" => isset($field_setting['placeholder']) ? esc_attr($field_setting['placeholder']) : esc_html__("Enter your email", "chaty"),
                                        "type"        => "email",
                                    ];
                                }
                                ...
                                if (isset($field_setting['is_active']) && $field_setting['is_active'] == "yes") {
                                    $contact_fields[] = [
                                        "field"       => "phone",
                                        "title"       => isset($field_setting['field_label'])? esc_attr($field_setting['field_label']) : esc_html__("Phone", "chaty"),
                                        "is_required" => (isset($field_setting['is_required']) && $field_setting['is_required'] == "yes") ? 1 : 0,
                                        "placeholder" => isset($field_setting['placeholder']) ? esc_attr($field_setting['placeholder']) : esc_html__("Enter your phone number", "chaty"),
                                        "type"        => "text",
                                    ];
                                }
                                ...
                                if (isset($field_setting['is_active']) && $field_setting['is_active'] == "yes") {
                                    $contact_fields[] = [
                                        "field"       => "message",
                                        "title"       => isset($field_setting['field_label'])? esc_attr($field_setting['field_label']) : esc_html__("Message", "chaty"),
                                        "is_required" => (isset($field_setting['is_required']) && $field_setting['is_required'] == "yes") ? 1 : 0,
                                        "placeholder" => isset($field_setting['placeholder']) ? esc_attr($field_setting['placeholder']) : esc_html__("Enter your message", "chaty"),
                                        "type"        => "textarea",
                                    ];
                                }
                            }//end if
