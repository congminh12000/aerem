                ...
                <div class="brxc-overlay__pannels-wrapper">
                    ...
                    <div class="brxc-overlay__pannel brxc-overlay__pannel-1">
                        ...
                        <div id="<?php echo esc_attr($prefix);?>ExtendWrapper" class="brxc-overlay__action-btn-wrapper right m-top-16 action-wrapper">
                            ...
                            <div class="brxc-overlay__action-btn primary" onClick='ADMINBRXC.expandClass(document.querySelector("#<?php echo esc_attr($overlay_id);?> input[name=<?php echo esc_attr($prefix);?>-styles]:checked").value, document.querySelector("#<?php echo esc_attr($prefix);?>propertyOptions"), document.querySelector("#<?php echo esc_attr($prefix);?>categoryOptions"), document.querySelector("#<?php echo esc_attr($overlay_id);?> input[name=<?php echo esc_attr($prefix);?>-position]:checked").value, document.querySelector("#<?php echo esc_attr($overlay_id);?> input[name=<?php echo esc_attr($prefix);?>-erase]:checked").value);ADMINBRXC.closeModal(event, event.target, "#<?php echo esc_attr($overlay_id);?>")'>
                                <span>Extend</span>
                            </div>
                        </div>
