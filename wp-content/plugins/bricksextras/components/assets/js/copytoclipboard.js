function xCopyToClipBoard() {
  ...
  function xCopyToClipBoardAJAX(e) {
    ...
    if ( typeof e.detail.queryId === 'undefined' ) {
        if ( typeof e.detail.popupElement === 'undefined' ) {
            ...
            extrasCopyToClipBoard( e.detail.popupElement )
        }
    }
  ...
  document.addEventListener("bricks/ajax/popup/loaded", xCopyToClipBoardAJAX)
  document.addEventListener("bricks/ajax/end", xCopyToClipBoardAJAX)
