...
class X_Tabs extends \Bricks\Element {
  ...
  public function enqueue_scripts() {
    ...
    wp_enqueue_script( 'x-tabs', BRICKSEXTRAS_URL . 'components/assets/js/tabs.js', ['x-frontend'], '1.0.7', true );
  }
    ...
    $config = [
	  ...
	  'duration' => isset( $settings['duration'] ) ? $settings['duration'] : 150,
	...
	$this->set_attribute( '_root', 'data-x-tab-wrap', $tabWap );
