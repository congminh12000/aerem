...
class X_Breadcrumbs extends \Bricks\Element {
  ...
  public function render() {
		...
		global $wp_query;
			...
			if ( is_home() && !is_front_page() ) {
				...
				if ( is_category() ) {
					...
					$crumbs[] = $this->get_tax_crumb($maybeParentTax, $maybeSchema,$maybeLinks,$maybeCPTarchive);
				} elseif ( is_year() ) {
				...
				$crumbs[] = $this->get_single_crumb($maybeParentTax,$maybeSchema,$priorityCategory,$maybeLinks,$maybeBlog, $maybeProductCategory, $maybeShop, $maybePostCategory, $excludeCategories, $excludeProductCategories, $maxLength );
			}
	...
	public function get_single_crumb($maybeParentTax,$maybeSchema,$priorityCategory,$maybeLinks,$maybeBlog,$maybeProductCategory, $maybeShop, $maybePostCategory, $excludeCategories, $excludeProductCategories,$maxLength) {
	...
	public function get_tax_crumb($maybeParentTax, $maybeSchema, $maybeLinks,$maybeCPTarchive) {
