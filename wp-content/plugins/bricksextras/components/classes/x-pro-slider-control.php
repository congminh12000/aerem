...
class X_Pro_Slider_Control extends \Bricks\Element {
  ...
  public function render() {
	...
	$contentTag = isset( $this->settings['contentTag'] ) ? $this->settings['contentTag'] : 'div';
    ...
    if ('progressBar' === $controlType ) {
      ...
      if ( isset( $settings['progressBarClickable'] ) ) {
        ...
        $this->set_attribute( 'x-slider_progress', 'aria-label', esc_attr__( 'Move to another slide' ) );
