...
class X_Back_To_Top extends \Bricks\Element {
  ...
  public function enqueue_scripts() {
    wp_enqueue_script( 'x-backtotop', BRICKSEXTRAS_URL . 'components/assets/js/backtotop.js', '', '1.0.2', true );
    if (! \BricksExtras\Helpers::elementCSSAdded($this->name) ) {
      wp_enqueue_style( 'x-backtotop', BRICKSEXTRAS_URL . 'components/assets/css/backtotop.css', [], '' );
    }
  }
  ...
  public function render() {
    ...
    $type = isset( $settings['type'] ) ? $settings['type'] : 'progress';
