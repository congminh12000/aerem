...
class X_Content_Timeline extends \Bricks\Element {
  ...
  public function render() {
    ...
    $horizontal = isset( $this->settings['horizontal'] ) ? $this->settings['horizontal'] : 'false';
    $scrollEffects = isset( $this->settings['scrollEffects'] ) ? $this->settings['scrollEffects'] : 'false';
    ...
    $listTag = isset( $this->settings['listTag'] ) ? esc_html($this->settings['listTag']) : 'div';
    ...
    if ('true' === $horizontal) {
      wp_enqueue_script( 'x-content-timeline-horizontal', BRICKSEXTRAS_URL . 'components/assets/js/contenttimelinehorizontal.js', '', '1.0.1', true );
    } else {
      wp_enqueue_script( 'x-content-timeline', BRICKSEXTRAS_URL . 'components/assets/js/contenttimeline.js', '', '1.0.5', true );
    }
