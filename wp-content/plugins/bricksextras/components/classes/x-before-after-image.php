...
class X_Before_After_Image extends \Bricks\Element {
  ...
  public function set_controls() {
    ...
    $this->controls['touchWidth'] = [
			'tab' => 'content',
      'group' => 'userInteraction',
			'label' => esc_html__( 'Touch width', 'bricks' ),
			'inline'      => true,
			'small'		  => true,
			'type' => 'number',
      'units' => true,
  ...
  public function enqueue_scripts() {
    wp_enqueue_script( 'x-before-after-image', BRICKSEXTRAS_URL . 'components/assets/js/beforeafterimage.js', '', '1.0.1', true );
    if (! \BricksExtras\Helpers::elementCSSAdded($this->name) ) {
      wp_enqueue_style( 'x-before-after-image', BRICKSEXTRAS_URL . 'components/assets/css/beforeafterimage.css', [], '' );
    }
  ...
  public function render() {
    ...
    $direction = isset( $this->settings['direction'] ) ? $this->settings['direction'] : 'horizontal';
