...
class X_Countdown extends \Bricks\Element {
	...
	public function enqueue_scripts() {
	    wp_enqueue_script( 'x-countdown', BRICKSEXTRAS_URL . 'components/assets/js/countdown.js', '', '1.0.1' );
		if (! \BricksExtras\Helpers::elementCSSAdded($this->name) ) {
			wp_enqueue_style( 'x-countdown', BRICKSEXTRAS_URL . 'components/assets/css/countdown.css', [], '' );
		}
	}
	...
	public function render() {
        ...
        $mode        = isset( $settings['mode'] ) ? $settings['mode'] : 'evergreen';
