...
class X_Popover extends \Bricks\Element {
  ...
  public function enqueue_scripts() {
    wp_enqueue_script( 'x-popper', BRICKSEXTRAS_URL . 'components/assets/js/popper.js', '', '1.0.1', true );
	  wp_enqueue_script( 'x-popover', BRICKSEXTRAS_URL . 'components/assets/js/popover.js', ['x-popper'], '1.0.5', true );
  ...
  public function render() {
    ...
    if ( isset( $this->settings['maybeTooltip'] ) ) {
      $config += [ 
        'elementSelector' => isset( $this->settings['elementSelector'] ) ? $this->settings['elementSelector'] : '.your-class-here',
