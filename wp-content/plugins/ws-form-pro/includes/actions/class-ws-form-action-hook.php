<?php
	...
	class WS_Form_Action_Hook extends WS_Form_Action {
											...
											if($message !== false) {
												...
												parent::success(sprintf(__('Message added to queue: %s', 'ws-form'), $message), array(
													...
													array(
														...
														'scroll_top_offset' => self::get_action_param($action_params, 'scroll_top_offset', '0'),
														'scroll_top_duration' => self::get_action_param($action_params, 'scroll_top_duration', '400'),
		...
		public function get_action_param($action_params, $param, $default_value = false) {
			...
			if(!is_array($action_params)) { return $default_value; }
