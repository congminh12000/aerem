			...
			return array(
				...
				'fields' => array(
					...
					'public' => array(
						...
						// Input group
						'mask_field_input_group'			=>	'#pre_label#pre_help<div class="input-group">#field</div>#post_label#invalid_feedback#post_help',
						...
						'class_help_pre'				=> array('help-text'),
						'class_help_post'				=> array('help-text'),
						...
						'field_types'				=> array(
							...
							'checkbox' 	=> array(
								...
								'class_inline' 			=> array(),
								'mask_field'			=> '#pre_help<div#attributes>#datalist</div>#invalid_feedback#post_help',
							...
							'radio' 				=> array(
								...
								'class_inline' 			=> array(),
								'mask_field'			=> '#pre_help<div#attributes>#datalist</div>#post_help',
								'mask_group'			=> '<fieldset#disabled>#group_label#group</fieldset>',
							...
							'file' 	=> array(
								...
								'mask_field_label'					=>	'<label id="#label_id" for="#id"#attributes>#label</label>',
								'mask_help_dropzonejs_preview'				=>	'<p class="#help_class"#attributes>#help#help_append</p>',
								'mask_invalid_feedback_dropzonejs_preview'	=>	'<span data-form-error-for="#id" class="#invalid_feedback_class"#attributes>#invalid_feedback</span>',
							...
							'progress'	=> array(
								...
								'mask_field'					=>	'#pre_label<div data-progress-bar role="progressbar" tabindex="0" aria-valuenow="#value" aria-valuemin="0" aria-valuemax="100" id="#id"#attributes><div data-progress-bar-value data=value="0" class="progress-meter"></div></div>#post_label',
