			...
			return array(
				...
				'fields' => array(
					...
					'public' => array(
						...
						// Input group
						'mask_field_input_group'			=>	'#pre_label#pre_help<div class="row collapse">#field</div>#post_label#post_help',
						...
						'class_help_pre'			=> array(),
						'class_help_post'			=> array(),
						...
						'field_types'		=> array(
							...
							'file' 	=> array(
								...
								'mask_field_label'					=> '<label id="#label_id" for="#id"#attributes>#label</label>',
								'mask_help_dropzonejs_preview'				=>	'<p#attributes>#help#help_append</p>',
								'mask_invalid_feedback_dropzonejs_preview'	=>	'<small data-form-error-for="#id" class="#invalid_feedback_class"#attributes>#invalid_feedback</small>',
							...
							'progress'	=> array(
								...
								'mask_field'					=>	'#pre_label<div data-progress-bar id="#id"#attributes><div data-progress-bar-value data=value="0" class="meter"></div></div>#post_label',
