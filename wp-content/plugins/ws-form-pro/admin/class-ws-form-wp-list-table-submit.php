...
//					break;
		...
		function column_id($item) {
			...
			switch($status) {
				...
				default :
					...
					// Edit in Preview
					if(
						WS_Form_Common::option_get('submit_edit_in_preview', '') &&
		...
		public function get_where() {
			...
			if($this->date_from != '') {
				...
				$date_from = WS_Form_Common::get_mysql_date(get_gmt_from_date(WS_Form_Common::get_date_by_site(WS_Form_Common::field_date_translate($this->date_from)) . ' 00:00:00'));
			...
			if($this->date_to != '') {
				...
				$date_to = WS_Form_Common::get_mysql_date(get_gmt_from_date(WS_Form_Common::get_date_by_site(WS_Form_Common::field_date_translate($this->date_to)) . ' 23:59:59'));
...
<?php
				...
				if($this->form_id > 0) {
?>
<input type="text" id="wsf_filter_date_from" name="date_from" value="<?php WS_Form_Common::echo_esc_attr($this->date_from); ?>" placeholder="<?php esc_attr_e('Date from', 'ws-form'); ?>" autocomplete="off" />

<input type="text" id="wsf_filter_date_to" name="date_to" value="<?php WS_Form_Common::echo_esc_attr($this->date_to); ?>" placeholder="<?php esc_attr_e('Date to', 'ws-form'); ?>" autocomplete="off" />
