...
<script>
	...
	(function($) {
		...
		$(function() {
			...
			$('[data-action="wsf-form-stat-reset"]').on('click', function() {
			...
			// Send test form statistics summary email
			$('[data-action="wsf-report-form-statistics-test"]').on('click', function() {

				// Reset
				wsf_obj.report_form_statistics_test(function() {

					// Show info message
					wsf_obj.message('<?php esc_html_e('Form statistics email successfully sent!', 'ws-form'); ?>', true, 'notice-success');
					...
					// Show info message
					wsf_obj.message('<?php esc_html_e('An error occurred while sending the form statistics email. Confirm the recipient email address is correct.', 'ws-form'); ?>', true, 'notice-error');
				...
				case 'static' :
					...
					switch($field) {
						...
						case 'license_status' : 
							...
							WS_Form_Common::echo_esc_html($plugin_licensing->license_status());
							break;
...
?>
<input type="button" class="wsf-button wsf-button-inline" data-action="wsf-mode-submit" data-mode="deactivate" value="<?php WS_Form_Common::echo_esc_attr('Deactivate', 'ws-form'); ?>"<?php WS_Form_Common::attributes_e($attributes); ?> />
<?php
						} else {
?>
<input type="button" class="wsf-button wsf-button-inline" data-action="wsf-mode-submit" data-mode="activate" value="<?php WS_Form_Common::echo_esc_attr('Activate', 'ws-form'); ?>"<?php WS_Form_Common::attributes_e($attributes); ?> />
<?php
						}
...
<?php
					...
					case 'wsf-report-form-statistics-test' :
?>
<input type="button" class="wsf-button wsf-button-inline" data-action="wsf-report-form-statistics-test" data-for="wsf_<?php WS_Form_Common::echo_esc_attr($field); ?>" value="<?php esc_attr_e('Send Test', 'ws-form'); ?>"<?php WS_Form_Common::attributes_e($attributes); ?> />
<?php
						break;
					default :
