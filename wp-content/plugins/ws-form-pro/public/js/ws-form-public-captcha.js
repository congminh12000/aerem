(function($) {
	...
	$.WS_Form.prototype.form_turnstile = function() {
		...
		turnstile_objects.each(function() {
			...
			if((turnstile_theme === undefined) || (['light', 'dark'].indexOf(turnstile_theme) == -1)) { turnstile_theme = 'light'; }
			...
			var config = {'sitekey': turnstile_site_key, 'theme': turnstile_theme, 'callback': function(token) {
