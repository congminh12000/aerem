...
class Create_Post
{
    ...
    public function run($form)
    {
        ...
        if ($post_thumbnail) {
            ...
            $post_thumbnail = $form->handle_file($post_thumbnail, $form_settings, $form_files, "id");
        }
        ...
        if (isset($form_settings['pro_forms_post_action_post_create_custom_fields'])) {
            foreach ($form_settings['pro_forms_post_action_post_create_custom_fields'] as $custom_field) {
                ...
                $custom_fields[$custom_field['name']] = $form->get_form_field_by_id($custom_field['value']);
            }
        }
