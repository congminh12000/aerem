...
class Create_Submission
{
    ...
    public function run($form)
    {
        ...
        $form_fields = $forms_helper->get_form_fields_from_ids($form_settings, $form_fields, $post_id, $form_id);

        if (isset($form_settings['submission_prevent_duplicates']) && $form_settings['submission_prevent_duplicates']) {
            $is_duplicate = $this->check_for_duplicates($form_settings, $form_fields, $form_id);
