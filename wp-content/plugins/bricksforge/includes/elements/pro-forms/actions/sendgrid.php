...
class Sendgrid
{
    ...
    public function run($form)
    {
        ...
        $first_name    = isset($form_settings['sendgridFirstName']) ? $form->get_form_field_by_id($form_settings['sendgridFirstName']) : false;
        $last_name     = isset($form_settings['sendgridLastName']) ? $form->get_form_field_by_id($form_settings['sendgridLastName']) : false;
        $email_address = isset($form_settings['sendgridEmail']) ? $form->get_form_field_by_id($form_settings['sendgridEmail']) : false;
