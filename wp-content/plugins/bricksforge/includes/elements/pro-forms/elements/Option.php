...
class Brf_Pro_Forms_Option extends \Bricks\Element
{
    ...
    public function render()
    {
        ...
        $parent_value = isset($field_wrapper['settings']['value']) ? $field_wrapper['settings']['value'] : false;
        ...
        if (isset($parent_value) && isset($value) && trim($parent_value) && (trim($parent_value) == bricks_render_dynamic_data(trim($value)))) {
