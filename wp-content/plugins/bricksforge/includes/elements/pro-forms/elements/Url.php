...
class Brf_Pro_Forms_Url extends \Bricks\Element
{

    public $category = 'bricksforge forms';
    public $name = 'brf-pro-forms-field-url';
    public $icon = 'fa-solid fa-link';
    public $css_selector = '';
    public $scripts = [];
    ...
    {
        return esc_html__("Url", 'bricksforge');
    }
    ...
    {
        $this->controls = array_merge($this->controls, Helper::get_default_controls('url'));
    ...
    public function render()
    {
         ...
         * Field
         */
        $this->set_attribute('field', 'type', 'url');
